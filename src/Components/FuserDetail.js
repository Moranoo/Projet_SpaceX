        ...
        <>
            <div>
                ...
                <Row xs={1} md={6} className='g-1'>
                    {data.flickr_images && data.flickr_images.map((image, index) => (
                        <Col key={index}>
                ...
                <Card.Body style={{ width: '20rem', textAlign: 'center' }}>
                    ...
                    <Card.Text>
                        Date du premier décollage : {data.first_flight}
                    </Card.Text>
                    <Card.Text>
                        Description :<br />
                        {data.description}
                    ...
                    {data.mass && (
                        <Card.Text>
                            Poids : {data.mass.kg} kg
                        </Card.Text>
                    )}
                    {data.engines && (
                        <>
                            <Card.Text>
                                Nombre de moteur : {data.engines.number}
                            </Card.Text>
                            <Card.Text>
                                Type de moteur : {data.engines.type}
                            </Card.Text>
                            <Card.Text>
                                Carburant : {data.engines.propellant_1}
                            </Card.Text>
                        </>
                    )}
                </Card.Body>
